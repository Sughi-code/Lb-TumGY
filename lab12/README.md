...
1. Убедитесь, что у вас установлены PHP 8+ и MySQL
2. Установите зависимости:
   ```bash
   cd public
   composer install
   ```
3. Настройте конфигурацию базы данных в `config.php`
...
2. **Механизм миграций**: Реализован автоматический запуск миграций при подключении к базе данных
